    ...
    return (
        <main>
            <div className='h-[80px] flex justify-center items-center bg-black w-[100%] relative'>
                <p className='mid-title font-semibold text-white leading-none'>Магазин</p>
            ...
            <div className="container flex flex-col items-center justify-center">
                ...
                <div className='w-[30%] aspect-square relative flex-col gap-5 border-black border-2 border-solid flex justify-center items-center white-shadow rounded-[50%] mt-14 mb-14'>
