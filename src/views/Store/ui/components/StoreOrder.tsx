    ...
    return (
        <div onClick={clickHandler} className='flex hover:scale-105 transition-transform duration-300 white-shadow border-solid border-black border-1 rounded-lg flex-col gap-2 items-center cursor-pointer'>
            <div className='relative w-[100%]'>
                <img className='aspect-square transition-opacity duration-300 rounded-md object-cover w-[100%] relative z-30 hover:opacity-0' alt='#' src={image}  />
                <img className='aspect-square rounded-md object-cover w-[100%] absolute left-0 top-0 h-[100%] z-20' alt='#' src={hoverImage}  />
            </div>
