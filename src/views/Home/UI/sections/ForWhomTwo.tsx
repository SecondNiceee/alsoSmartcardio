      ...
      <div className="container gap-containerGap p-container flex flex-col">
        ...
        <div className="flex w-full relative">
          ...
          <div className="lg:w-[31%] flex my-auto justify-center">
            <PrevButton className="lg:w-full md:hidden top-[37%] md:top-1/2 left-0 z-20 -translate-y-1/2 absolute lg:relative prev-forWhom lg:scale-150" arrowType="circle" />
            <NextButton
              className="lg:w-full top-[37%] md:top-1/2 right-0 z-20 -translate-y-1/2 absolute lg:relative next-forWhom lg:scale-150"
              arrowType="circle"
            />
          </div>
        </div>
