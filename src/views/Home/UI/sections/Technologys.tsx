                    ...
                    <div className="technologys__tblock">
                        <div className="technologys__description">
                            ...
                            <ul className='technologys__benefits'>
                                ...
                                <li>- помогает снимать показатели, когда это действительно информативно, например, при изменении самочувствия или переменах в образе жизни</li>
                                <li>- хранит историю ритма Вашего сердца</li>
                            </ul>
                            <p>Современная медицина не стоит на месте, и доступными становятся не только технологии, но и знания. Подробнее о работе сердечно-сосудистой системе читайте в нашем блоге.</p>
