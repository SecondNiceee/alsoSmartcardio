...
const Generation = () => {
    return (
        <section className='section relative'>
            ...
            <img className="w-[15%] md:block hidden absolute left-[5%] top-[10%] opacity-50 blur-[30px]" src={"/images/logo.jpg"} alt='Смарткардио для ЭКГ' />
            <img className="right-[5%] md:block hidden bottom-[10%] absolute w-[15%] opacity-50 blur-[30px]" src={"/images/logo.jpg"} alt='Измерение экг'/>
