...
const Generation = () => {
    return (
        <section className='section relative'>
            ...
            <img className="w-[15%] md:block hidden absolute left-[5%] top-[10%] opacity-50 blur-[30px]" src={"/images/logo.jpg"} alt='#' />
            <img className="right-[5%] md:block hidden bottom-[10%] absolute w-[15%] opacity-50 blur-[30px]" src={"/images/logo.jpg"} alt='#'/>
            ...
            <div  className="container relative z-30 gap-containerGap p-container flex flex-col">
                ...
                <Reveal character={CHARACTER.LEFT} className="relative">
                    ...
                    <img  alt="generation" className='max-w-[880px] rounded-2xl w-full object-cover h-[300px] sm:h-[400px] md:h-[500px] mx-auto relative z-30'  src={"/images/generation.webp"}  />
                </Reveal>
