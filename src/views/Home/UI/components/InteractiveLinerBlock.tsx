...
const InteractiveLinerBlock = () => {
  return (
    <svg
      className="interactive__liner-block"
      width="910"
      height="927"
      viewBox="0 0 910 927"
      fill="none"
    ...
    >
      <g filter="url(#filter0_f_78_1075)">
        <path
          d="M333.001 759.5L265.5 692C141.216 642.775 -5.16106 418.24 265.501 286.5C265.501 286.5 609.595 79.3295 670.218 117.721C670.218 117.721 814.746 342.586 1002 318L675.5 692L494 814L333.001 759.5Z"
...
export default InteractiveLinerBlock;
