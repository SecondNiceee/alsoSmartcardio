...
const RecognitionImages = () => {
    return (
        <div className='flex  max-w-[800px] w-[100%] items-center  p-5 rounded-2xl justify-center'>
            <div className='flex w-[100%] md:w-[unset] my-auto justify-center'>
                ...
                <Image alt='#' src={'/images/phones.png'} width={900} height={1000} className='sm:w-[80%] w-[100%] md:w-[100%]' />
            </div>
        </div>
    );
};
