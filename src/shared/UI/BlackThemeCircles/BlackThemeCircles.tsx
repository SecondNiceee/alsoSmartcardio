...
const BlackThemeCircles = () => {
    return (
        <>
            ...
            <div className="absolute left-[40%] z-20 opacity-70 bottom-[-10%] bg-purple-600 w-[200px] h-[200px] blur-[200px]"></div>
            <div className="absolute right-[40%] z-20 opacity-70 top-[-10%] bg-purple-600 w-[200px] h-[200px] blur-[200px]"></div>
        </>
    );
};
